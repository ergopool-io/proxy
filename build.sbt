...
coverageExcludedPackages := "<empty>;.*List.*;.*MiningAction.*;.*Logger.*;.*Helper.*;.*MiningDisabledException.*;.*PoolRequestException.*;.*route.*;.*Route.*;.*EagerLoaderModule.*;.*StartupService.*"
coverageMinimum := 85
